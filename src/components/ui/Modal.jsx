    ...
    <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 animate-fade-in">
      ...
      <div className={`relative bg-white w-full ${SIZE_MAP[size]} rounded-2xl shadow-2xl flex flex-col max-h-[85vh]`}>
        ...
        <div className="flex items-start justify-between px-6 py-4 border-b border-stone-100 flex-shrink-0">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 flex items-center justify-center rounded-xl hover:bg-stone-100 text-stone-400 hover:text-stone-600 transition-colors ml-4 flex-shrink-0"
          >
